...
class Ui_introducirPartido(object):
    def setupUi(self, introducirPartido):
        ...
        self.botonAdd.setMinimumSize(QtCore.QSize(200, 30))
        self.botonAdd.setMaximumSize(QtCore.QSize(200, 16777215))
        font = QtGui.QFont()
        ...
        self.botonRes = QtWidgets.QPushButton(introducirPartido)
        self.botonRes.setMinimumSize(QtCore.QSize(200, 30))
        self.botonRes.setMaximumSize(QtCore.QSize(200, 16777215))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.botonRes.setFont(font)
        self.botonRes.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.botonRes.setAutoDefault(True)
        self.botonRes.setObjectName("botonRes")
        self.horizontalLayout_4.addWidget(self.botonRes)
    ...
    def retranslateUi(self, introducirPartido):
        ...
        self.botonAdd.setText(_translate("introducirPartido", "Insertar Partido"))
        self.botonRes.setText(_translate("introducirPartido", "Resetear"))
