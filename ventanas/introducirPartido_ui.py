...
class Ui_introducirPartido(object):
    def setupUi(self, introducirPartido):
        ...
        introducirPartido.resize(480, 320)
        ...
        introducirPartido.setMinimumSize(QtCore.QSize(480, 320))
        introducirPartido.setMaximumSize(QtCore.QSize(480, 320))
        font = QtGui.QFont()
        ...
        self.label_2.setStyleSheet("background-color: rgba(199, 199, 199, 150);")
