...
class Ui_errorCampo(object):
    def setupUi(self, errorCampo):
        ...
        errorCampo.setWindowModality(QtCore.Qt.WindowModal)
        errorCampo.resize(400, 200)
        ...
        errorCampo.setMinimumSize(QtCore.QSize(400, 200))
        errorCampo.setMaximumSize(QtCore.QSize(400, 200))
        font = QtGui.QFont()
        ...
        self.label01.setMinimumSize(QtCore.QSize(280, 60))
        self.label01.setMaximumSize(QtCore.QSize(280, 60))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label01.setFont(font)
        self.label01.setAutoFillBackground(False)
        self.label01.setStyleSheet("background-color: rgb(230, 206, 240);\n"
